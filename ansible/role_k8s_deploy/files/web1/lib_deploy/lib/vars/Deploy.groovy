...
kubectl create secret docker-registry regcred --docker-username=AWS --docker-server=728490037630.dkr.ecr.eu-north-1.amazonaws.com --docker-password=$(aws ecr get-login-password --region eu-north-1)